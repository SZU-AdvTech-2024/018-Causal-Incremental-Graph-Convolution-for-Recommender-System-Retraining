...
class Trainer(object):
    ...
    def train_model(self):
        ...
        logger.info(f"epoch is:  %s" % epoch)
        logger.info(f"average time per epoch is:  %s" % (total_time/epoch))
        return saved_dict
    ...
    def save_model(self, model):
        ...
        torch.save(model.state_dict(), os.path.join(self.model_path+'/'+self.model_name, 'lr_'+str(self.learning_rate)+'_'+'reg_'+str(self.reg_weight)+'_'+self.model_name + self.TIME + '.pth'))
